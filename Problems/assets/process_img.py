...
# Read the image
image = cv2.imread(
    '/media/phuongnam-d/920C22060C21E5C7/Freelancer/Vieoney/CppPractices/Problems/assets/Flag_of_Vietnam.png')

image = cv2.resize(image, (int(A/0.4), int(math.ceil(2 * A/3))))
